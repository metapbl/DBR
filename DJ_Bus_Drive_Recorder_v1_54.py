...
#
#   Seoul_Bus_Drive_Recorder와 동일한 점 (v1.54에서 이식):
...
# 【6-1】 __init__()
#   메인 창 초기화. 처리 순서:
#   1) 창 제목("대진여객 버스 운행기록 수집 프로그램 v1.53")·크기·아이콘 설정
...
# ──────────────────────────────────────────────────────────
        super().__init__()
        self.setWindowTitle("대진여객 버스 운행기록 수집 프로그램 v1.54")
